...
characteristics <- function(d, child_char = NULL, child_char_names = NULL, mom_char = NULL, mom_char_names = NULL) {
  ...
  mom <- c('momage', 'momheight_cont', 'momeduy', mom_char, 'cesd_sum_t2', 'cesd_sum_ee_t3_cont', 'pss_sum_mom_t3_cont', 'life_viol_any_t3')
...
save_as_docx("Table 1" = enroll, path=paste0(here(), "/Bangladesh/results/tables/enrollment_tbl.docx"), 
