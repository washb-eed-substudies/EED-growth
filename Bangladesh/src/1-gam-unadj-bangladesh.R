...
H1_unadj_res_BH <- total[1:64,]
H2_unadj_res_BH <- total[65:104,]
H3_unadj_res_BH <- total[105:128,]
H4_unadj_res_BH <- total[129:173,]
H5_unadj_res_BH <- total[174:nrow(total),]


saveRDS(total, here("Bangladesh/results/unadjusted/all_results.RDS"))
saveRDS(H1_unadj_res_BH, here("Bangladesh/results/unadjusted/H1_res.RDS"))
saveRDS(H2_unadj_res_BH, here("Bangladesh/results/unadjusted/H2_res.RDS"))
saveRDS(H3_unadj_res_BH, here("Bangladesh/results/unadjusted/H3_res.RDS"))
saveRDS(H4_unadj_res_BH, here("Bangladesh/results/unadjusted/H4_res.RDS"))
saveRDS(H5_unadj_res_BH, here("Bangladesh/results/unadjusted/H5_res.RDS"))
