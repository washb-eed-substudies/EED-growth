...
saveRDS(total, here("Kenya/results/adjusted/all_results.RDS"))
saveRDS(H1_adj_res_BH, here("Kenya/results/adjusted/H1_res.RDS"))
saveRDS(H2_adj_res_BH, here("Kenya/results/adjusted/H2_res.RDS"))
saveRDS(H3_adj_res_BH, here("Kenya/results/adjusted/H3_res.RDS"))
saveRDS(H4_adj_res_BH, here("Kenya/results/adjusted/H4_res.RDS"))
saveRDS(H5_adj_res_BH, here("Kenya/results/adjusted/H5_res.RDS"))
